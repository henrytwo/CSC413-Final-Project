...
with Deep Convolutional Generative Adversarial Networks}\cite{dcgan}.
        ...
        Kernel Size: 3, Stride: 2, Padding: 1, Leaky ReLU slope: 0.2.
        Argmax is taken across the output of the linear units for classification.
        \\\\
        ...
        This supports the hypothesis that StyleGAN mimics the real dataset than COCO-GAN.
