...
with Deep Convolutional Generative Adversarial Networks}\cite{dcgan}.
        ...
        \\\\
        The classifier was implemented using Pytorch with Cross Entropy loss, the Adam optimizer ($\alpha=0.1$), and the following network architecture:
        \begin{verbatim}
test
...
\end{verbatim}
        \\\\
        To avoid introducing bias, all three datasets (training, validation, test) were equally balanced with real and generated images.
        The 5000 generated images were further divided in half between images from StyleGAN and COCO-GAN.
        ...
        Data Set     & Accuracy\\
         \hline
        Training        & 82.1\% of 5000 \\
         \hline
        Validation      & 66.8\% of 2500 \\
         \hline
        Test (Real)     & 58.4\% of 1250 \\
         \hline
        Test (StyleGAN) & 62.4\% of 625  \\
         \hline
        Test (COCO-GAN) & 86.4\% of 625 \\
         \hline
        \end{tabular}
        \\

        The model was able to identify the origin of an image the majority of the time.
        ...
        (i.e. all 5000 generated images are all from one model)
