...
\begin{document}
    ...
    \begin{multicols*}{2}
        ...
        The fake images were further divided in half between images from StyleGAN and COCO-GAN .
        Out of the combined pool of 20000 images, 10000 were allocated for testing, 5000 validation, and 5000 testing.
        \\\\
